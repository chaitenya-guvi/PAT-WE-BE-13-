...
favorite_colors(rusty='green', Chaitenya='blue', Roopan = 'black', Sangeetha = 'blue', Sathya = 'red')
...
print(special_greeting(Chaitenya='Hello'))
# Hello Chaitenya!
print(special_greeting(Bob='hello'))
# Not sure who this is...
print(special_greeting(Chaitenya='special'))
# You get a special greeting Chaitenya!
