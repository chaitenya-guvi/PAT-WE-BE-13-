...
list_of_webelement_of_fullname_using_name = driver.find_elements(By.NAME,"uname")
print("i have found the element full name using NAME locator")
print(f"The locator is this webelement  : {list_of_webelement_of_fullname_using_name[0]}")
...
for item in webelements_of_labels_using_tag_name:
    print(f"the label is : {item.text}")
